...
if __name__ == '__main__':
    ...
    r1.cmd('zebra -f ./configs/zebra.conf -d -i /var/run/quagga/zebraR1.pid')
    r1.cmd('bgpd -f ./configs/quagga1.conf -d -i /var/run/quagga/bgpdR1.pid')

    r2 = net.get('r2')
    r2.cmd('ifconfig r2-eth1 192.168.2.254 broadcast 192.168.2.255 netmask 255.255.255.0')
    r2.cmd('sysctl -w net.ipv4.ip_forward=1')
    r2.cmd('zebra -f ./configs/zebra.conf -d -i /var/run/quagga/zebraR2.pid')
    r2.cmd('bgpd -f ./configs/quagga2.conf -d -i /var/run/quagga/bgpdR2.pid')
